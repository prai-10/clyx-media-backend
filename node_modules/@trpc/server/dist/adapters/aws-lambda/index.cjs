...
const v1Processor = {
	...
	toResult: async (response) => {
		...
		return require_getErrorShape._objectSpread2(require_getErrorShape._objectSpread2({}, cookies.length && { multiValueHeaders: { "set-cookie": cookies } }), {}, {
...
function awsLambdaRequestHandler(opts) {
	return async (event, context) => {
		...
		const createContext = async (innerOpts) => {
			...
			return await ((_opts$createContext = opts.createContext) === null || _opts$createContext === void 0 ? void 0 : _opts$createContext.call(opts, require_getErrorShape._objectSpread2({
				event,
				context
			}, innerOpts)));
		};
		const response = await require_resolveResponse.resolveResponse(require_getErrorShape._objectSpread2(require_getErrorShape._objectSpread2({}, opts), {}, {
			createContext,
			req: planner.request,
			path: planner.path,
			error: null,
			onError(o) {
				var _opts$onError;
				opts === null || opts === void 0 || (_opts$onError = opts.onError) === null || _opts$onError === void 0 || _opts$onError.call(opts, require_getErrorShape._objectSpread2(require_getErrorShape._objectSpread2({}, o), {}, { req: event }));
			}
		}));
...
function awsLambdaStreamingRequestHandler(opts) {
	return async (event, responseStream, context) => {
		...
		const createContext = async (innerOpts) => {
			...
			return await ((_opts$createContext2 = opts.createContext) === null || _opts$createContext2 === void 0 ? void 0 : _opts$createContext2.call(opts, require_getErrorShape._objectSpread2({
				event,
				context
			}, innerOpts)));
		};
		const response = await require_resolveResponse.resolveResponse(require_getErrorShape._objectSpread2(require_getErrorShape._objectSpread2({}, opts), {}, {
			...
			onError(o) {
				var _opts$onError2;
				opts === null || opts === void 0 || (_opts$onError2 = opts.onError) === null || _opts$onError2 === void 0 || _opts$onError2.call(opts, require_getErrorShape._objectSpread2(require_getErrorShape._objectSpread2({}, o), {}, { req: event }));
			}
		}));
