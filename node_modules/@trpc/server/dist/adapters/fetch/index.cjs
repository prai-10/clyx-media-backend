...
async function fetchRequestHandler(opts) {
	...
	const createContext = async (innerOpts) => {
		...
		return (_opts$createContext = opts.createContext) === null || _opts$createContext === void 0 ? void 0 : _opts$createContext.call(opts, require_getErrorShape._objectSpread2({
			req: opts.req,
			resHeaders
		}, innerOpts));
	};
	...
	return await require_resolveResponse.resolveResponse(require_getErrorShape._objectSpread2(require_getErrorShape._objectSpread2({}, opts), {}, {
		req: opts.req,
		createContext,
		path,
		error: null,
