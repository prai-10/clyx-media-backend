import { Un as CallerOverride, ii as MaybePromise, kn as ErrorHandlerOptions, li as Simplify, yt as CreateContextCallback, zr as TRPCError } from "../unstable-core-do-not-import-B9ZnrQAU.cjs";
 ...
 */
export declare const rethrowNextErrors: (error: TRPCError) => void;
//#endregion
export { nextAppDirCaller as experimental_nextAppDirCaller, notFound as experimental_notFound, redirect as experimental_redirect };
