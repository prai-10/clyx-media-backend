import { n as observable } from "./observable-DwUFSuKv.mjs";
...
const isDeepEqual = (a, b) => {
	if (a === b) return true;
	return !!(a && b && typeof a === "object" && typeof b === "object") && Object.keys(a).length === Object.keys(b).length && Object.entries(a).every(([k, v]) => isDeepEqual(v, b[k]));
};
...
//#endregion
export { share as a, map as i, distinctUntilChanged as n, tap as o, distinctUntilDeepChanged as r, behaviorSubject as t };

//# sourceMappingURL=observable-CSprJVOf.mjs.map