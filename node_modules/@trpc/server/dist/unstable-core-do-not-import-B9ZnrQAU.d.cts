import { l as inferObservableValue, m as Observable } from "./index-BMimGNYb.cjs";
 ...
 **/
declare function transformTRPCResponse<TResponse extends TRPCResponse | TRPCResponse[] | TRPCResponseMessage | TRPCResponseMessage[]>(config: RootConfig<AnyRootTypes>, itemOrItems: TResponse): (TRPCResponse | TRPCResponseMessage)[] | TRPCErrorResponse<TRPCErrorShape<object>> | TRPCSuccessResponse<unknown> | ({
  id: JSONRPC2.RequestId;
...
declare function transformResultInner<TRouter extends AnyRouter, TOutput>(response: TRPCResponse<TOutput, inferRouterError<TRouter>> | TRPCResponseMessage<TOutput, inferRouterError<TRouter>>, transformer: DataTransformer): {
  ...
  readonly ok: true;
  readonly result: TRPCResult<TOutput> | {
    type: 'started';
    data?: never;
  } | {
    type: 'stopped';
...
//#endregion
export { Lazy as $, identity as $n, GetRawInputFn as $r, JSONRPC2 as $t, OctetInput as A, LegacyObservableSubscriptionProcedure as An, ParserSuperstructEsque as Ar, sseStreamProducer as At, inferRouterOutputs as B, inferSubscriptionOutput as Bn, getCauseFromUnknown as Br, DefaultErrorData as Bt, JSONRPC2_TO_HTTP_CODE as C, TRPCRequestInfo as Cn, ParseFn as Cr, isServerDefault as Ct, getStatusKeyFromCode as D, AnyQueryProcedure as Dn, ParserMyZodEsque as Dr, SSEStreamProducerOptions as Dt, getStatusCodeFromKey as E, AnyProcedure as En, ParserCustomValidatorEsque as Er, SSEStreamConsumerOptions as Et, getErrorShape as F, SubscriptionProcedure as Fn, ParserZodEsque as Fr, ProducerOnError as Ft, AnyClientTypes as G, ProcedureCallOptions as Gn, TRPC_ERROR_CODE_NUMBER as Gr, CombinedDataTransformer as Gt, inferTransformedSubscriptionOutput as H, AnyProcedureBuilder as Hn, TRPC_ERROR_CODES_BY_KEY as Hr, ErrorFormatter as Ht, createFlatProxy as I, inferProcedureInput as In, getParseFn as Ir, WebReadableStreamEsque as It, AnyRouter as J, inferProcedureBuilderResolverOptions as Jn, Dict as Jr, DataTransformerOptions as Jt, InferrableClientTypes as K, ProcedureResolverOptions as Kn, retryableRpcCodes as Kr, CombinedDataTransformerClient as Kt, createRecursiveProxy as L, inferProcedureOutput as Ln, inferParser as Lr, isPromise as Lt, octetInputParser as M, Procedure as Mn, ParserWithInputOutput as Mr, ConsumerOnError as Mt, getAcceptHeader as N, ProcedureType as Nn, ParserWithoutInput as Nr, JSONLProducerOptions as Nt, formDataToObject as O, AnySubscriptionProcedure as On, ParserScaleEsque as Or, sseHeaders as Ot, getRequestInfo as P, QueryProcedure as Pn, ParserYupEsque as Pr, NodeJSReadableStreamEsque as Pt, DecorateRouterRecord as Q, emptyObject as Qn, FilterKeys as Qr, transformTRPCResponse as Qt, GetInferenceHelpers as R, inferProcedureParams as Rn, StandardSchemaV1 as Rr, jsonlStreamConsumer as Rt, HTTP_CODE_TO_JSONRPC2 as S, TRPCAcceptHeader as Sn, middlewareMarker as Sr, RootTypes as St, getHTTPStatusCodeFromError as T, AnyMutationProcedure as Tn, ParserArkTypeEsque as Tr, SSEPingOptions as Tt, Serialize as U, CallerOverride as Un, TRPC_ERROR_CODES_BY_NUMBER as Ur, defaultFormatter as Ut, inferTransformedProcedureOutput as V, procedureTypes as Vn, getTRPCErrorFromUnknown as Vr, DefaultErrorShape as Vt, SerializeObject as W, ProcedureBuilder as Wn, TRPC_ERROR_CODE_KEY as Wr, parseTRPCMessage as Wt, CreateRouterOptions as X, abortSignalsAnyPonyfill as Xn, ErrorSymbol as Xr, getDataTransformer as Xt, BuiltRouter as Y, UnsetMarker as Yn, DistributiveOmit as Yr, defaultTransformer as Yt, DecorateCreateRouterOptions as Z, assert as Zn, Filter as Zr, transformResult as Zt, resolveResponse as _, HTTPBaseHandlerOptions as _n, MiddlewareResult as _r, mergeRouters as _t, SubscribedPromise as a, Overwrite as ai, TRPCErrorResponse as an, run as ar, RouterCallerFactory as at, isAbortError as b, ResponseMeta as bn, createOutputMiddleware as br, CreateRootTypes as bt, takeWithGrace as c, Result$1 as ci, TRPCRequest as cn, TrackedEnvelope as cr, callProcedure as ct, Deferred as d, Unwrap as di, TRPCResponseMessage as dn, sse as dr, getProcedureAtPath as dt, IntersectionError as ei, TRPCClientIncomingMessage as en, isAsyncIterable as er, MergeRouters as et, createDeferred as f, ValidateShape as fi, TRPCResult as fn, tracked as fr, inferRouterContext as ft, initTRPC as g, inferAsyncIterableYield as gi, BaseHandlerOptions as gn, MiddlewareFunction as gr, lazy as gt, TRPCRootObject as h, coerceAsyncIterableToArray as hi, TRPCSuccessResponse as hn, MiddlewareBuilder as hr, inferRouterRootTypes as ht, ProxyPromise as i, MaybePromise as ii, TRPCConnectionParamsMessage as in, noop as ir, RouterCallerErrorHandler as it, UtilityParser as j, MutationProcedure as jn, ParserValibotEsque as jr, EventSourceLike as jt, FileLike as k, ErrorHandlerOptions as kn, ParserStandardSchemaEsque as kr, sseStreamConsumer as kt, makeAsyncResource as l, Simplify as li, TRPCRequestMessage as ln, inferTrackedOutput as lr, createCallerFactory as lt, TRPCBuilder as m, WithoutIndexSignature as mi, TRPCSubscriptionStopNotification as mn, AnyMiddlewareFunction as mr, inferRouterMeta as mt, PromiseExecutor as n, KeyFromValue as ni, TRPCClientOutgoingMessage as nn, isObject as nr, RouterBuilder as nt, StandardSchemaV1Error as o, PickFirstDefined as oi, TRPCErrorShape as on, sleep as or, RouterDef as ot, RuntimeConfigOptions as p, ValueOf as pi, TRPCResultMessage as pn, AnyMiddlewareBuilder as pr, inferRouterError as pt, inferClientTypes as q, createBuilder as qn, DeepPartial as qr, DataTransformer as qt, PromiseWithResolvers as r, Maybe as ri, TRPCClientOutgoingRequest as rn, mergeWithoutOverrides as rr, RouterCaller as rt, iteratorResource as s, ProtectedIntersection as si, TRPCReconnectNotification as sn, TrackedData as sr, RouterRecord as st, Unpromise as t, InvertKeyValue as ti, TRPCClientIncomingRequest as tn, isFunction as tr, Router as tt, makeResource as u, TypeError as ui, TRPCResponse as un, isTrackedEnvelope as ur, createRouterFactory as ut, parseConnectionParamsFromString as v, HTTPErrorHandler as vn, createInputMiddleware as vr, AnyRootTypes as vt, getHTTPStatusCode as w, TRPCRequestInfoProcedureCall as wn, Parser as wr, SSEClientOptions as wt, throwAbortError as x, ResponseMetaFn as xn, experimental_standaloneMiddleware as xr, RootConfig as xt, parseConnectionParamsFromUnknown as y, ResolveHTTPRequestOptionsContextFn as yn, createMiddlewareFactory as yr, CreateContextCallback as yt, inferRouterInputs as z, inferSubscriptionInput as zn, TRPCError as zr, jsonlStreamProducer as zt };
//# sourceMappingURL=unstable-core-do-not-import-B9ZnrQAU.d.cts.map