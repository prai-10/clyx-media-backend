	...
	return new Promise((resolve) => {
		...
		return handleViaMiddleware(opts.req, opts.res, (err) => {
			require_codes.run(async () => {
				...
				await writeResponse({
					request,
					response: await require_resolveResponse.resolveResponse(require_getErrorShape._objectSpread2(require_getErrorShape._objectSpread2({}, opts), {}, {
						req: request,
						error: err ? require_tracked.getTRPCErrorFromUnknown(err) : null,
						createContext,
						onError(o) {
							var _opts$onError2;
							opts === null || opts === void 0 || (_opts$onError2 = opts.onError) === null || _opts$onError2 === void 0 || _opts$onError2.call(opts, require_getErrorShape._objectSpread2(require_getErrorShape._objectSpread2({}, o), {}, { req: opts.req }));
						}
					})),
