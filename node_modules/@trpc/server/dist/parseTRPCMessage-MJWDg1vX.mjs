import { u as isObject } from "./codes-D5Ya6_Bi.mjs";
...
function assertIsRequestId(obj) {
	if (obj !== null && typeof obj !== "string" && (typeof obj !== "number" || isNaN(obj))) throw new Error("Invalid request id");
}
/* istanbul ignore next -- @preserve */
...
//#endregion
export { procedureTypes as n, parseTRPCMessage as t };

//# sourceMappingURL=parseTRPCMessage-MJWDg1vX.mjs.map