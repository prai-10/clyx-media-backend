import { c as isAsyncIterable, p as run, u as isObject } from "./codes-D5Ya6_Bi.mjs";
import { n as _objectSpread2, t as getErrorShape } from "./getErrorShape-B0JBUs-i.mjs";
import { g as getTRPCErrorFromUnknown, i as callProcedure, m as TRPCError, p as transformTRPCResponse, t as isTrackedEnvelope } from "./tracked-D4jU_Hb3.mjs";
import { t as parseTRPCMessage } from "./parseTRPCMessage-MJWDg1vX.mjs";
import { b as parseConnectionParamsFromUnknown, d as _usingCtx, l as iteratorResource, m as Unpromise } from "./resolveResponse-JtMyT9TQ.mjs";
import { r as observableToAsyncIterable, t as isObservable } from "./observable-DwUFSuKv.mjs";
import { r as createURL } from "./node-http-BUlb5EdB.mjs";
		...
		*/
		...
		function handleRequest(msg, batchIndex) {
			...
			if (lastEventId !== void 0) {
				if (isObject(input)) input = _objectSpread2(_objectSpread2({}, input), {}, { lastEventId });
				else {
					var _input;
		...
		client.on("message", (rawData, isBinary) => {
			...
			if (!ctxPromise) {
				ctxPromise = createCtxPromise(() => {
					...
					return parseConnectionParamsFromUnknown(msg.data);
				});
				return;
			}
			run(() => {
				try {
					...
					return (Array.isArray(msgJSON) ? msgJSON : [msgJSON]).map((raw) => parseTRPCMessage(raw, transformer));
				} catch (cause) {
					const error = new TRPCError({
						code: "PARSE_ERROR",
						cause
...
//#endregion
export { jsonEncoder as i, getWSConnectionHandler as n, handleKeepAlive as r, applyWSSHandler as t };

//# sourceMappingURL=ws-C7ZOJJeA.mjs.map