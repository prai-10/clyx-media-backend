...
function observableToAsyncIterable(observable, signal) {
	const reader = observableToReadableStream(observable, signal).getReader();
	const iterator = {
		async next() {
...
//#endregion
export { observableToPromise as i, observable as n, observableToAsyncIterable as r, isObservable as t };

//# sourceMappingURL=observable-DwUFSuKv.mjs.map