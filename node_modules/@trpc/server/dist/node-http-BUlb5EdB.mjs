...
import { g as getTRPCErrorFromUnknown, m as TRPCError, p as transformTRPCResponse } from "./tracked-D4jU_Hb3.mjs";
import { h as isAbortError, t as resolveResponse } from "./resolveResponse-JtMyT9TQ.mjs";
	...
	return new Promise((resolve) => {
		...
		return handleViaMiddleware(opts.req, opts.res, (err) => {
			run(async () => {
				...
				await writeResponse({
					request,
					response: await resolveResponse(_objectSpread2(_objectSpread2({}, opts), {}, {
						req: request,
						error: err ? getTRPCErrorFromUnknown(err) : null,
						createContext,
						onError(o) {
							var _opts$onError2;
							opts === null || opts === void 0 || (_opts$onError2 = opts.onError) === null || _opts$onError2 === void 0 || _opts$onError2.call(opts, _objectSpread2(_objectSpread2({}, o), {}, { req: opts.req }));
						}
					})),
...
//#endregion
export { incomingMessageToRequest as i, nodeHTTPRequestHandler as n, createURL as r, internal_exceptionHandler as t };

//# sourceMappingURL=node-http-BUlb5EdB.mjs.map